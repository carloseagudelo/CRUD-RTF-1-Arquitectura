...
class ComentsControllerTest < ActionController::TestCase
  ...
  test "should create coment" do
    assert_difference('Coment.count') do
      post :create, coment: { coment: @coment.coment, movie_id: @coment.movie_id, socio_id: @coment.socio_id }
    end
  ...
  test "should update coment" do
    patch :update, id: @coment, coment: { coment: @coment.coment, movie_id: @coment.movie_id, socio_id: @coment.socio_id }
    assert_redirected_to coment_path(assigns(:coment))
  end
